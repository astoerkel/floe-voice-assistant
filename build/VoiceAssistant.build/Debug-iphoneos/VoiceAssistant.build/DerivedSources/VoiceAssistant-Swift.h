...
#ifndef VOICEASSISTANT_SWIFT_H
#define VOICEASSISTANT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VoiceAssistant",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC14VoiceAssistant12OAuthService")
@interface OAuthService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASWebAuthenticationSession;
@interface OAuthService (SWIFT_EXTENSION(VoiceAssistant)) <ASWebAuthenticationPresentationContextProviding>
...
SWIFT_CLASS("_TtC14VoiceAssistant14WatchConnector")
@interface WatchConnector : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@class NSString;
@interface WatchConnector (SWIFT_EXTENSION(VoiceAssistant)) <WCSessionDelegate>
...
SWIFT_CLASS("_TtC14VoiceAssistant16WebSocketManager")
